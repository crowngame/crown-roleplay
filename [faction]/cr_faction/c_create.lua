function birlikKurGUI()
	...
	birlikWindow = guiCreateWindow((screenW - 288) / 2, (screenH - 321) / 2, 288, 321, "Crown Roleplay - Birlik Sistemi", false)
...
function birlikSeviyeGUI(birlikIsmi, birlikLevel)
	...
	seviyeWindow = guiCreateWindow((screenW - 289) / 2, (screenH - 181) / 2, 289, 230, "Crown Roleplay - Birlik Seviyesi ", false)
