function ustAramaOnayGUI(arayan, aranan)
    ...
    ustAramaSorWindow = guiCreateWindow((screenW - 455) / 2, (screenH - 141) / 2, 455, 141, "Crown Roleplay - Üst Arama Sistemi", false)
...
addEvent("pd:ustAramaOnayGUIss", true)
addEventHandler("pd:ustAramaOnayGUIss", root, ustAramaOnayGUI)