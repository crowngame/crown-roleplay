...
function createGateManagerWindow(gatesList)
	...
	gWin = guiCreateWindow(sx/2-400,sy/2-300,800,600,"Gates Manager " .. version .. " © 2013 Crown Roleplay",false)
	...
	--iUGLogo = guiCreateStaticImage(0.8,0.035,0.14,0.0883,":cr_resources\logo.png",true,gWin)
