...
local colorizePed = {116 / 255, 192 / 255, 252 / 255} -- rgba colors 
...
function dxDrawInteractionButton(key, label, x, y, w, h, buttonColor, activeColor, textColor, font, textAlign1, textAlign2, imagePath, imageW, imageH, imageColor)
	...
	dxDrawRectangle(x + 10, y, w - 20, h-5, exports.cr_ui:isInBox(x + 10, y, w - 20, h - 5) and tocolor(16, 16, 16, 255) or tocolor(32, 32, 32, 255))
