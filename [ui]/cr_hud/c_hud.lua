...
addCommandHandler("hudgizle", function()
	local data = getElementData(localPlayer, "hudgizli")
	setElementData(localPlayer, "hudgizli", data == false and true or false)
	local text = data == false and "gizlendi." or "aktif edildi."
	outputChatBox("[!]#FFFFFF Başarıyla hud arayüzünüz " .. text, 0, 255, 0, true)
end)
