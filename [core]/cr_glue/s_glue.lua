...
function gluePlayer(slot, vehicle, x, y, z, rotX, rotY, rotZ)
	...
	exports.cr_logs:logMessage("[/GLUE] " .. getElementData(source, "account:username") .. "/" ..  getPlayerName(source)  .. " glued to #" ..  getElementData(vehicle, "dbid") .. " - " .. getElementModel(vehicle), 4)
...
function glueVehicle(attachedTo, x, y, z, rotX, rotY, rotZ)
	...
	exports.cr_logs:logMessage("[/GLUE] " .. getElementData(client, "account:username") .. "/" ..  getElementData(source, "dbid")  .. " glued to #" ..  getElementData(attachedTo, "dbid") .. " - " .. getElementModel(attachedTo), 4)
end
