...
function adminEditPedGui(element)
	if exports.cr_integration:isPlayerTrialAdmin(localPlayer) or exports.cr_integration:isPlayerScripter(localPlayer) then
...
function canPlayerUseLevel(level)
	if level == 0 then
		return true
	elseif level == 1 then
		return exports.cr_integration:isPlayerTrialAdmin(localPlayer) or exports.cr_integration:isPlayerScripter(localPlayer)
	elseif level == 2 then
		return exports.cr_integration:isPlayerGameAdmin(localPlayer) or exports.cr_integration:isPlayerScripter(localPlayer)
	elseif level == 3 then
		return exports.cr_integration:isPlayerHeadAdmin(localPlayer) or exports.cr_integration:isPlayerScripter(localPlayer)
	elseif level == 4 then
		return exports.cr_integration:isPlayerManagement(localPlayer) or exports.cr_integration:isPlayerScripter(localPlayer)
	elseif level == 5 then
		return exports.cr_integration:isPlayerScripter(localPlayer)
	end
	return false
end
