addEvent("voice:broadcastUpdate", true)
addEventHandler("voice:broadcastUpdate", root, function(broadcastList)
...
function publicVoice(thePlayer, commandName, channelID)
	if authorizeds[getElementData(thePlayer, "account:username")] then
...
addCommandHandler("publicvoice", publicVoice, false, false)