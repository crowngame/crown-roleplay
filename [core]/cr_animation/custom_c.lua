...
addCommandHandler("animpanel", function()
	if getElementData(localPlayer, "loggedin") == 1 then
		if isElement(window) then destroyElement(window) end
		window = guiCreateWindow(0, 0, 549, 335, "Crown Roleplay - Özel Animasyon Arayüzü", false)
		...
		use = guiCreateButton(9, 300, 267, 31, "Kullan", false, window)
					...
					if row ~= -1 then
						...
						if customtable[index] or anims_list[index] then
							if (anims_list[index][2] == true) then
								...
								outputChatBox("[!]#FFFFFF Animasyon fiziği olmayan paketleri komut ile kullanabilirsiniz, komutları görebilmek için listeden çift tıklayın.", 255, 0, 0, true)
							end
						else
							outputChatBox("[!]#FFFFFF Animasyon verisi bulunamadı.", 255, 0, 0, true)
						end
					else
						outputChatBox("[!]#FFFFFF Henüz bir animasyon seçmediniz.", 255, 0, 0, true)
					end
