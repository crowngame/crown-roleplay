...
addEventHandler("job-system-trucker:displayAllMarkers", getRootElement() , displayAllMarkers)
...
function delTruckerMarker(cm, id) 
	...
	if not exports.cr_integration:isPlayerTrialAdmin(sourcePlayer) then
