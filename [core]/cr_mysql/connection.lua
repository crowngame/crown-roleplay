...
local username = "root"
local password = "pV6fJypNSE1G0bafJcIh"
local database = "crp_data"
local port = 3306
...
function connectToDatabase(res)
	...
	conn = dbConnect("mysql", "dbname=" .. database .. ";host=" .. hostname .. ";charset=latin1", username, password, "autoreconnect=1")
