...
addEventHandler( 'onClientResourceStart', resourceRoot, function()
  engineReplaceCOL( engineLoadCOL( 'donmedolap.col' ), 3752 );
...
function getInside( key, state, col )
	if exports.cr_global:hasMoney(getLocalPlayer(), 10) then
	  ...
	  bindKey( bdKey[ 2 ], 'down', leaveCabin );
		...
		outputChatBox("[!]#FFFFFF Dönme dolaba binmek için yeterli paranız yok.", 255, 0, 0, true)
		playSoundFrontEnd(4)
	end
end;
