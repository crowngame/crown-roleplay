...
function getElementZoneName(theElement)
	...
	if int == 0 and dim == 0 then
		if getElementType(theElement) == "interior-system" then
		...
		local dimension, entrance, exit, interiorType, interiorElement = exports['cr_interior']:findProperty(theElement)
