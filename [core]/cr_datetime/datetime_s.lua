...
addEventHandler("onResourceStart", resourceRoot, function()
	...
	serverCurrentTimeSec = tonumber(exports.cr_mysql:query_fetch_assoc("SELECT TO_SECONDS(NOW()) AS `timesec` ")['timesec'])
end)
...
function getNow(player)
	...
	local serverSec = tonumber(exports.cr_mysql:query_fetch_assoc("SELECT TO_SECONDS(NOW()) AS `timesec` ")['timesec'])
