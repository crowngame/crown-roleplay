function sitOnChair(x, y, z, rz, chair, offset)
	...
	exports.cr_global:applyAnimation(source, "FOOD", "FF_Sit_Look", -1, true, false, true)
	--exports.cr_global:sendLocalMeAction(source, "sandayenin demirinden destek alarak sandalyeye oturur.")
...
function standUp(chair)
	...
	--exports.cr_global:sendLocalMeAction(client, "sandayenin demirinden destek alarak sandalyeden kalkar.")
