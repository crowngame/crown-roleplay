...
function FlappyUI:RenderDeadMenu()
	if(self.deadmenuEnabled == true) then
		...
		dxDrawText(self.score, (self.iSX/2)+110, ((self.iSY/2)+50/2)+75, 150, 50, tocolor(0, 0, 0, self.renderScoreAlpha), 1, "pricedown", "center", "center")

		dxDrawText(bestScore, (self.iSX/2)+115, ((self.iSY/2)+50/2)+160, 150, 50, tocolor(0, 0, 0, self.renderScoreAlpha), 1, "pricedown", "center", "center")
...
function FlappyUI:RenderScore()
	if(self.renderScore == true) then
		...
		dxDrawText(self.score, (self.iSX/2)-30+5, ((self.iSY/2)+50/2)-185, 150, 50, tocolor(0, 0, 0, self.renderScoreAlpha), 2, "pricedown", "center", "center")
		dxDrawText(self.score, (self.iSX/2)-30, ((self.iSY/2)+50/2)-190, 150, 50, tocolor(255, 255, 255, self.renderScoreAlpha), 2, "pricedown", "center", "center")
