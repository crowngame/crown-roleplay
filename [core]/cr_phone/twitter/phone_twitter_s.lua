...
local sortId = 0
local advertisementMessages = { "metal", "samp", "arıyorum", "aranır", "istiyom", "istiyorum", "SA-MP", "Roleplay", "ananı", "sikeyim", "sikerim", "orospu", "evladı", "Kye", "arena", "Arina", "rina", "vendetta", "vandetta", "shodown", "Vedic", "vedic","ventro","Ventro", "server", "sincityrp", "ls-rp", "sincity", "tri0n3", "mta", "mta-sa", "query", "Query", "Repsand", "p2win", "pay to win" }
local spamTimers = {}
...
addListener("twitter:retweet",
    function(player, hashKey)
        ...
        if not exports.cr_integration:isPlayerDeveloper(player) then
