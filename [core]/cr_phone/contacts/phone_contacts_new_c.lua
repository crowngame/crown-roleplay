...
function guiNewContact(number)
	if isPhoneGUICreated() then
		...
		lName_contacts_new = guiCreateLabel(30,50,50,20, "Adı:", false, wPhoneMenu)
		fName_contacts_new = guiCreateEdit(30+50,50,150,20, "", false, wPhoneMenu)
		guiEditSetMaxLength(fName_contacts_new, 50)

		lNumber = guiCreateLabel(30,50+30,50,20, "Numara:", false, wPhoneMenu)
		fNumber_contacts_new = guiCreateEdit(30+50,50+30,150,20, number or "", false, wPhoneMenu)
		guiEditSetMaxLength(fNumber_contacts_new, 20)

		local bW, bH = 100, 35
		bAddContact = guiCreateButton(30,50+30*2,bW,bH, "Ekle", false, wPhoneMenu)
		guiSetEnabled(bAddContact, false)
		bCancelContact = guiCreateButton(30+bW+2,50+30*2,bW,bH, "Kapat", false, wPhoneMenu)
