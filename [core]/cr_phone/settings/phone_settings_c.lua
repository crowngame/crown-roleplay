...
function drawSettings(xoffset, yoffset)
	...
	settingGuis.main = guiCreateScrollPane(30+xoffset, 55+yoffset, 221, 370, false, wPhoneMenu)
    ...
    guiLabelSetColor(settingGuis[1], 255, 255, 255)
    ...
    guiLabelSetColor(settingGuis[2], 255, 255, 255)

    yoffset = yoffset + smallLine
    settingGuis[3] = guiCreateLabel(20+xoffset, 30+yoffset, 190, smallLine, "SIM: Vodafone", false, settingGuis.main)
    guiSetFont(settingGuis[3], "default-small")
    guiLabelSetColor(settingGuis[3], 255, 255, 255)
    ...
    guiLabelSetColor(settingGuis[29], 255, 255, 255)
    ...
    guiLabelSetColor(settingGuis[20], 255, 255, 255)

    guiSetAlpha(guiCreateStaticImage(10+xoffset, 28+yoffset, 200, 1, ":cr_admin/components/whitedot.jpg", false, settingGuis.main), 0.1)
    yoffset = yoffset + 3
    local spacing = 7
    ...
    guiLabelSetColor(settingGuis[21], 255, 255, 255)
    ...
    guiLabelSetColor(settingGuis[23], 255, 255, 255)
    ...
    guiLabelSetColor(settingGuis[6], 255, 255, 255)
    ...
    yoffset = yoffset + smallLine
    guiLabelSetColor(settingGuis[10], 255, 255, 255)
    ...
    guiLabelSetColor(settingGuis[9], 255, 255, 255)
    ...
    guiLabelSetColor(settingGuis[25], 255, 255, 255)
    ...
    guiLabelSetColor(settingGuis[28], 255, 255, 255)
    ...
    guiSetFont(settingGuis[15], "default-small")
     guiLabelSetColor(settingGuis[15], 255, 255, 255)
    ...
    guiLabelSetColor(settingGuis[18], 255, 255, 255)
    ...
    guiSetFont(settingGuis[30], "default-bold-small")
     guiLabelSetColor(settingGuis[30], 255, 255, 255)
    ...
    guiLabelSetColor(settingGuis[31], 255, 255, 255)
    ...
    guiSetFont(settingGuis[33], "default-small")
        guiLabelSetColor(settingGuis[33], 255, 255, 255)
...
function guiSettingClick()
	...
	elseif source == settingGuis[32] then
		if guiGetText(settingGuis[32]) == "Aktif" then
			setElementData(localPlayer, "cellphone_log", "0")
			guiSetText(settingGuis[32], "Pasif")
		else
			setElementData(localPlayer, "cellphone_log", "1")
			guiSetText(settingGuis[32], "Aktif")
			--exports.cr_logs:drawInfoBox()
		end
