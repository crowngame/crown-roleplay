...
function giveBoatLicense(usingGC)
	...
	--exports.cr_hud:sendBottomNotification(source, "Department of Motor Vehicles", "Congratulations! You are now fully licensed captain a boat on the water.")
	exports.cr_global:giveItem(source, 155, getPlayerName(source):gsub("_"," "))
