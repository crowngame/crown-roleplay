addEventHandler('onClientResourceStart', resourceRoot,
    function()
        local txd = engineLoadTXD('cuff.txd',true)
        engineImportTXD(txd, 9651)
        local dff = engineLoadDFF('cuff.dff', 9651)
        engineReplaceModel(dff, 9651)
        ...
        local txd = engineLoadTXD('des_nwtownpolice.txd', 11453 )
        engineImportTXD(txd, 11453 )
