...
function removeOOC(text)
	if not text then
		outputChatBox("Error code 0001 occurs, please report to Crown Roleplay MTA Scripting Team at http://forums.crownroleplay.net/forms.php?do=form&fid=1")
		return ""
	end
...
function useItem(itemSlot, additional)
	...
	if itemID then
		...
		elseif (itemID==16) then -- clothes
			...
			setElementData(source, "clothing:id", clothingid, true)
...
function isWatchingTV(player)
	return exports['cr_freecam-tv']:isPlayerFreecamEnabled(player)
end
