...
function showItemList()
	if (exports.cr_integration:isPlayerHeadAdmin(localPlayer) or exports.cr_integration:isPlayerTrial(localPlayer) or exports.cr_integration:isPlayerScripter(localPlayer)) then
