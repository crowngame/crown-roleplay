...
function isThisGunDuplicated(itemValue, fromPlayer)
	...
	if (row1+row2) > 1 then
		...
		exports.cr_global:sendMessageToAdmins("[ITEM SYSTEM] Weapon duplicate detected and deleted from player " ..(fromPlayer and exports.cr_global:getPlayerName(fromPlayer) or "Unknown").. ".")
		return true
	end
