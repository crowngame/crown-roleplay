    ...
    function ()
        for i,v in pairs (blasters) do
            ...
            if sx and distance <= 10 then
                ...
                local streams = exports.cr_carradio:getStreams()
                exports.cr_ui:drawFramedText("#" .. itemValue .. " - " .. streams[itemValue][1], sx, sy, sx, sy, tocolor(255, 255, 255, 255), 0.85, "default-bold", "center")
                
                if type(song) == "string" then
                    exports.cr_ui:drawFramedText("Oynuyor: " .. song, sx, sy + 15, sx, sy, tocolor(255, 255, 255, 255), 0.85, "default-bold", "center")
                end
            end
        end
    end)
