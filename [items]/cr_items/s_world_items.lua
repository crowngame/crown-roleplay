...
function dropItem(itemID, x, y, z, ammo, keepammo)
	...
	if not ammo then
		...
		if itemID == 60 or itemID == 137 or itemID == 138 or itemID == 134 or itemID == 115 or itemID == 116 or itemID == 175 and not exports.cr_integration:isPlayerGameAdmin(source) then
		...
		elseif itemID == 139 then
			...
			elseif (itemID == 147) then -- Picture Frame
				local dimension = getElementDimension(source)
				if dimension > 0 or (exports.cr_integration:isPlayerHeadAdmin(source) and exports.cr_global:isAdminOnDuty(source)) or exports.cr_integration:isPlayerScripter(source) then
...
addEventHandler('item:move:save', root,
	function(x, y, z, rx, ry, rz)
		...
		if exports.cr_global:isStaffOnDuty(client) or exports.cr_integration:isPlayerTrialAdmin(client) or exports.cr_integration:isPlayerScripter(client) then
			...
			local itemID = getElementData(source, "itemID")
			if itemID == 138 and not exports.cr_integration:isPlayerGameAdmin(client) then
