...
function frames_showTexGUI ()
	...
	if interiorID >= 1 or (exports.cr_integration:isPlayerHeadAdmin(localPlayer) and exports.cr_global:isAdminOnDuty(localPlayer)) or exports.cr_integration:isPlayerScripter(localPlayer) then
		if exports.cr_global:hasItem (localPlayer, 4, interiorID) or exports.cr_global:hasItem (localPlayer, 5, interiorID) or (exports.cr_integration:isPlayerGameAdmin(localPlayer) and exports.cr_global:isAdminOnDuty(localPlayer)) or (interiorID==0) then
