...
function openFeedBackForm(target)
	...
	gui.window[1] = guiCreateWindow(x, y, w, h, "Crown Roleplay - Geribildirimi Puanlama", false)
		...
		if #feedbacks > 0 then
			...
			local function formatFrom(from)
				if not from then
					...
					return exports.cr_integration:isPlayerHeadAdmin(localPlayer) and from or "(Hidden)"
				end
			end
