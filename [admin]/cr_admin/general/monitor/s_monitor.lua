function doMonitorList(sourcePlayer, command, targetPlayerName, ...)
	if (exports.cr_integration:isPlayerTrialAdmin(sourcePlayer) or exports.cr_integration:isPlayerHelper(sourcePlayer)) then
		if not targetPlayerName then
			...
			triggerClientEvent(sourcePlayer, "onMonitorPopup", sourcePlayer, dataTable, exports.cr_integration:isPlayerTrialAdmin(sourcePlayer) or exports.cr_integration:isPlayerHelper(sourcePlayer))		
		else
			if not ... then
