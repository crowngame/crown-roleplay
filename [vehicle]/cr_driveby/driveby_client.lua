...
local customBlockName = "customDriveBy"

local IFP = engineLoadIFP("drivebys.ifp", customBlockName)
if not IFP then
    outputConsole("Failed to load 'drivebys.ifp'")
end

engineReplaceAnimation(localPlayer, "ped", "drivebyl_l", customBlockName, "drivebyl_l")
engineReplaceAnimation(localPlayer, "ped", "drivebyl_r", customBlockName, "drivebyl_r")
engineReplaceAnimation(localPlayer, "ped", "driveby_l", customBlockName, "driveby_l")
engineReplaceAnimation(localPlayer, "ped", "driveby_r", customBlockName, "driveby_r")