...
function openVehlib(thePlayer)
	if exports.cr_integration:isPlayerVCTMember(thePlayer) or exports.cr_integration:isPlayerManagement(thePlayer) then
...
function giveTempVctAccess(thePlayer, commandName, targetPlayer)
	if exports.cr_integration:isPlayerHeadAdmin(thePlayer) or exports.cr_integration:isPlayerVehicleConsultant(thePlayer) then
		if not targetPlayer then
			...
			if not exports.cr_integration:isPlayerVCTMember(targetPlayer) and not exports.cr_integration:isPlayerHeadAdmin(thePlayer) then
			...
			if not hasVctAdmin then
				if not (exports.cr_integration:isPlayerHeadAdmin(thePlayer) or exports.cr_integration:isPlayerVehicleConsultant(thePlayer)) then
