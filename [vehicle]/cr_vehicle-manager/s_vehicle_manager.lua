...
function getVehicleWeight (thePlayer, commandName, specifiedVehicle)
	if exports.cr_integration:isPlayerVehicleConsultant(thePlayer) or exports.cr_integration:isPlayerGameAdmin(thePlayer) or exports.cr_integration:isPlayerVCTMember(thePlayer) then
