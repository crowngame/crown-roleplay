...
function createVehManagerWindow(data)
    ...
    -- vehList1 = vehList
    gWin = guiCreateWindow(sx / 2 - 400, sy / 2 - 300, 800, 600, "Crown Roleplay - Araç Yöneticisi", false)
...
function createCheckVehWindow(result, adminTitle, history, notes1)
    ...
    if result[1][21] then
        ...
        false)
        guiSetEnabled(bRemoveVeh1, exports.cr_integration:isPlayerHeadAdmin(localPlayer))
