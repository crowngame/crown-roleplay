...
function destroyBlip()
	for key, value in ipairs(getPlayersInTeam(exports.cr_pool:getElement("team", 4))) do
		outputChatBox("The unit no longer requires assistance. Resume normal patrol", value, 255, 194, 14)
	end
	for k,v in ipairs(getPlayersInTeam(exports.cr_pool:getElement("team", 4))) do
...
function removeBackup(thePlayer, commandName)
	if exports.cr_integration:isPlayerTrialAdmin(thePlayer) or (getElementData(thePlayer, "faction") == 4 and getElementData(thePlayer, "factionleader") == 1) then
