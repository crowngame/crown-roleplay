...
function cBeginGUI()
	...
	greetingWindow = guiCreateStaticImage(x, y, width, height, ":cr_resources/window_body.png", false)
...
function editPlateWindow()
	...
	if (source == vehlist) and not (svnum == "") then
		...
		efinalWindow = guiCreateStaticImage(x, y, width, height, ":cr_resources/window_body.png", false)
