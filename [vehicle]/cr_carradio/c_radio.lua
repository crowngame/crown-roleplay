...
addEventHandler(":settings:updateCarRadio", getRootElement(), updateCarRadio)
...
function showMP3GUI()
	...
	mp3Window = guiCreateStaticImage(mp3_x, mp3_y, mp3_w, mp3_h, ":cr_resources/window_body.png", false)
